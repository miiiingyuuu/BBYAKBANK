...
API_KEY = 'c17ba3a57147b7feb78ff59885d6c27e'
...
with open(save_dir, 'w', encoding="utf-8") as f:
    ...
    for i in range(N):
        ...
        file['fields'] = {
            ...
            'salary': random.randrange(0, 100000, 500),  # 연봉
            'wealth': random.randrange(0, 500000, 777),  # 자산
            'tendency': random.randint(1, 3), # 1: 1년 미만, 2: 1~2년 사이, 3: 2년 이상
            'gender': random.randint(1, 2), # 1: 남자, 2: 여자
        }
