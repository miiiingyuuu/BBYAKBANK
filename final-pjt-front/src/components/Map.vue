<template>
    ...
    <div style="display: flex; align-items: center; justify-content: center;  margin-top: 40px;"  >
        ...
        <select v-model="selectedDistrict" class="mr-2">
            <option value="">구 선택</option>
            <template v-if="selectedCity === '강원도'">
                <option v-for="district in gangwon" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '경기도'">
                <option v-for="district in gyeonggi" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '경상남도'">
                <option v-for="district in gyeongsangnam" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '경상북도'">
                <option v-for="district in gyeongsangbuk" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '광주광역시'">
                <option v-for="district in gwangju" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '대구광역시'">
                <option v-for="district in daegu" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '대전광역시'">
                <option v-for="district in daejeon" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '부산광역시'">
                <option v-for="district in busan" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '서울특별시'">
                <option v-for="district in seoul" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '울산광역시'">
                <option v-for="district in ulsan" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '인천시'">
                <option v-for="district in incheon" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '전라남도'">
                <option v-for="district in jeonnam" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '전라북도'">
                <option v-for="district in jeonbuk" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '제주특별자치도'">
                <option v-for="district in jeju" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '충청남도'">
                <option v-for="district in chungnam" :value="district">{{ district }}</option>
            </template>
            <template v-else-if="selectedCity === '충청북도'">
                <option v-for="district in chungbuk" :value="district">{{ district }}</option>
            </template>
        </select>
      ...
      > 
        ...
        현 지도에서 해당 은행 검색</button>
    </div>
  
      
        <div class="map-container elevation-7" >
...
const chungnam = ["계룡시","공주시","논산시","당진시","보령시","서산시","아산시","천안시","금산군","부여군","서천군","예산군","청양군","태안군","홍성군"]
...
watch([selectedCity, selectedDistrict, selectedBank], () => {
  ...
  if (selectedDistrict.value) {
    keyword.value += `${selectedDistrict.value}`
  }
